...
int monthly_rate(double hourly_rate, double discount) {
    ...
    // discount.
    double monthly_rate_afterDiscount = apply_discount(daily_rate(hourly_rate), discount) * 22;
    return ceil(monthly_rate_afterDiscount);
}
...
int days_in_budget(int budget, double hourly_rate, double discount) {
    ...
    int daily_rate_after = apply_discount(daily_rate(hourly_rate), discount);
    return floor(budget / daily_rate_after);
}